...
const Sidebar = ({ children, selectedLink }) => {
  return (
    <div className="flex">
      ...
      <aside className="hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0 border-r border-gray-200 sticky top-0">
        <div className="py-6 text-gray-500 dark:text-gray-400">
          ...
          <ul className="mt-8">
            ...
            <li>
              <Link href="/service/chats" className={`relative px-6 py-3 transition-colors duration-150 inline-flex items-center w-full text-sm font-semibold text-gray-800 dark:text-gray-100 ${selectedLink === 'settings' ? 'bg-purple-500' : 'hover:bg-purple-100 dark:hover:bg-gray-700'}`}>
                <FontAwesomeIcon icon="" className="mr-4" />
                <span>Chats</span>
              </Link>
            </li>
